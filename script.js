...
arrDescription = [
  ...
  "Fish are one of the most low maintenance pets you can get, and are often reffered to as a 'beginners pet'. They do not require attention from you, but you still have to do weekly water changes to you tank and treat it with the right chemicals, so your fish can stay healthy. There are many different types of fish, and you will have to do research on the specific kind you want. Some require a water heater and must maintain the water tempurature for their body.",
